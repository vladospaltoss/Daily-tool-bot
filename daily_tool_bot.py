...
help_kb = ReplyKeyboardMarkup(resize_keyboard=True,
                              one_time_keyboard=True).row(
                                  weather_btn, money_btn, qoute_btn)
...
async def start(msg: types.Message) -> None:
    if msg.chat.type == 'private':
        ...
        await msg.answer(
            'Добро пожаловать! Я <b>Daily Bot</b>, каждое утро я буду присылать тебе свежую информацию.\nДругие функции можно узнать с помощью комманды <b>/help</b> ',
            parse_mode='HTML',
...
async def quote(msg: types.Message) -> None:
    try:
        ...
        req = requests.get(
            'https://wikiphile.ru/570-fraz-o-motivacii/?ysclid=le2s2e8ouu459711332',
            proxies=proxies)
    ...
    for user in users:
        try:
            ...
            headers = {
                ...
                'cookie':
                '__cf_bm=zRd.cB6QSqIji6uoJe468.oBemHDtsINpvgP_P5hrcs-1676488839-0-Ab38wTDsXh0HIHDRG2u2LsZAZl2Nn3F11BNIENISOI50fgHVL96EWpo6BkmtZ3Sp8D8u+Kmwdc6bQdyROhRXO7pdFfgt6B0DULBtYDhEPilzIr8PDfmMbBaNVCyw63TZw5UVKdVueQHgtOfKo9RsCak=',
            ...
            proxies = {
                'http': 'http://ttNkVLRS:63cYXNdr@195.245.103.252:64534'
            }
            ...
            await bot.send_message(user[0], text=f'<b>---{datetime.datetime.now().strftime("%d.%m.%Y")}---</b>\n'
                                   '\n'
